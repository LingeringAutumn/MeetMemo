...
class DataMigrationManager {
    ...
    func migrateMeeting(_ meeting: Meeting) -> Meeting? {
        ...
        if migratedMeeting.dataVersion < 4 {
            migratedMeeting.oneLiner = ""
            migratedMeeting.decisions = []
            migratedMeeting.risks = []
            migratedMeeting.openQuestions = []
        ...
        if migratedMeeting.dataVersion < 6 {
            migratedMeeting.milestones = []
            migratedMeeting.dataVersion = 6
        }
        ...
        if migratedMeeting.dataVersion < 8 {
            migratedMeeting.structuredSummarySourceHash = ""
            migratedMeeting.structuredSummaryGeneratedAt = nil
            migratedMeeting.dataVersion = 8
        }
